...
The goal of the **FHIR-Starter** is to ease the deployment of Azure API for FHIR along with a Service Client to get users up and running with FHIR in minutes rather than days.  
