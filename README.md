...
## Script details
The following Azure resources will be deployed when you run `deployFhirStarter.bash`. Detailed deployment instructions are available in the [scripts](./scripts) directory.
